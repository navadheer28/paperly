...
export default function PdfToWord() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await pdfToWord(file)
      setResult(res.data)
      setStatus('done')
    } catch (err) {
      setStatus('error')
    ...
    <div style={{ backgroundColor: '#FAFAF8' }} className="min-h-screen pt-28 pb-20 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-gray-900 mb-3">PDF to Word</h1>
          <p className="text-gray-500 text-lg">Convert your PDF into an editable Word document</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
          ...
          <div className="space-y-2">
            {[
              'Fully editable DOC/DOCX file',
              'Layout and formatting preserved',
              'Images and tables included',
              'Ready to edit in Microsoft Word',
            ].map((item) => (
              <div key={item} className="flex items-center gap-3">
                <div style={{ backgroundColor: '#DBEAFE' }} className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0">
        ...
        {status === 'converting' && (
          <div className="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-700">Converting your PDF to Word...</p>
